...
public class ExperimentPowerFields {
    ...
    // public static SpireField<Boolean> freeToCompleteOnce = new SpireField<>(() -> false); // Currently unused
    public static SpireField<Boolean> doNotComplete = new SpireField<>(() -> false); // Used for Accrection Disc
