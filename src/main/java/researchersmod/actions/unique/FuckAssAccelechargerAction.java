...
import researchersmod.actions.common.AddBetterEtherealModAction;
...
public class FuckAssAccelechargerAction extends AbstractGameAction {
    ...
    public void update() {
        ...
        Wiz.atb(new BetterSelectCardsAction(Wiz.p().drawPile.group,this.amount,String.format(DESCRIPTIONS,this.amount,plural),false,(c -> {
