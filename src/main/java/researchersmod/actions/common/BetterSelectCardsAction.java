...
public class BetterSelectCardsAction
    ...
    public void update() {
        if (this.duration == this.startDuration) {
            ...
            if (anyNumber) {
                AbstractDungeon.gridSelectScreen.open(selectGroup, amount, true, this.text);
            }
            else {
                AbstractDungeon.gridSelectScreen.open(selectGroup, amount, this.text, false, false, false, false);
            }
            tickDuration();
        }
