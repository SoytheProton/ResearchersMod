...
public class AddPhaseAndEtherealAction extends AbstractGameAction {
    ...
    public AddPhaseAndEtherealAction(int amount, boolean isRandom){
    ...
    public void update() {
        if (this.isRandom) {
            for (int i = 0; i < this.amount; i++) {
                ...
                Wiz.att(new AddPhaseModAction(c));
